       ...
       <div class="container">
         <!-- <div class="text-center">
           ...
           >
             ...
             <li class="leading-none text-dark">
                <NuxtLink class="text-sm leading-none" href="/dashboard/tickets"> / BILLETS</NuxtLink>
             </li>
           </ul>
         </div> -->
       ...
       <div class="row">
         <div class="mx-auto text-center lg:col-8">
           <ul class="filter-list mt-8 flex flex-wrap items-center justify-center">
             <li>
               <NuxtLink class="filter-btn btn btn-sm" :class="($route.name == 'dashboard-tickets' || $route.name == 'dashboard-carpooling-ticket-id') ?'filter-btn-active':''" href="/dashboard/tickets">BILLETS</NuxtLink>
             </li> 
             <li>
               <NuxtLink class="filter-btn btn btn-sm" :class="($route.name == 'dashboard-carpooling-requests') ?'filter-btn-active':''" href="/dashboard/carpooling/requests">COVOITURAGE DEMANDE</NuxtLink>
             </li>
           </ul>
         </div>
       </div>
