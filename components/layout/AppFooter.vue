...
<footer class="footer bg-theme-light/50">
  <div class="container">
    <div class="row gx-5 pb-10 pt-[52px]">
      <div class="col-12 mt-12 md:col-6 lg:col-3">
        ...
        <p class="mt-6">
          CultuRide : Votre guide incontournable pour découvrir les événements culturels en France. Concerts, festivals, théâtre et bien plus encore – plongez dans l'univers de l'Art et de la Culture.
        </p>
      </div>
      <div class="col-12 mt-12 md:col-6 lg:col-3">
        <h6>Réseaux sociaux</h6>
        <p>chaousari.e2304870@etud.univ-ubs.fr</p>
      ...
      <div class="col-12 mt-12 md:col-6 lg:col-3">
        ...
        <ul>
          <li>
            <NuxtLink href="/signin">Se Connecter</NuxtLink>
          </li>
          <li>
            <NuxtLink href="/signup">S'inscrire</NuxtLink>
          </li>
          <li>
            <NuxtLink href="/carpooling-locations">Lieux de covoiturage</NuxtLink>
          </li>
          <li>
      ...
      <div class="col-12 mt-12 md:col-6 lg:col-3">
        ...
        <p>Le Campus de Vannes</p>
        <p> Rue André Lwoff, 56000 Vannes</p>
      </div>
    </div>
  </div>
  <div class="container max-w-[1440px]">
    ...
    >
      <p>powered by  <a href="#" target="_blank">culturide</a></p>
    </div>
  </div>
</footer>
</template>
